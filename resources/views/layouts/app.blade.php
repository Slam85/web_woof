        ...
        <nav class="navbar navbar-expand-lg  fixed-top text-white bg-danger sticky-top p-2">
            <div class="container-fluid">
                <div class="row d-flex">
                    ...
                    <div class="col-auto">
                        <img class="logonav m-1" style="border-radius:10px;" src="{{ asset('storage/images/')}}/{{Auth::user()->uuid}}.jpg " />
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <li class="nav-item d-flex bg-danger ">
                        @if (Route::has('login'))
                        @auth
                        <a href="{{route ('posts.create')}}"><button type="button" class="btn btn-outline-light m-2">Create Post</button></a>
                        <a href="{{route ('index')}}"><button type=" button" class="btn btn-outline-light  m-2">My Posts</button></a>
                        <a href="{{route ('user.edit')}}"><button type=" button" class="btn btn-outline-light  m-2">Profile</button></a>
                        <a href="{{route ('deconnexion')}}"><button type="button" class="btn btn-outline-light  m-2">LogOut</button></a>
                        @else
                        <a href="{{route ('login')}}"><button type="button" class="btn btn-outline-light m-2">LogIn</button></a>
                        <a href="{{route ('register')}}"><button type="button" class="btn btn-outline-light m-2">Register</button></a>
                        @endauth
                        @endif
                    </li>
                </div>
